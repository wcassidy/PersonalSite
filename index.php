...
<div class="container-fluid">
    ...
    <div class="row paragraph_row">
        ...
        <div class="col-12 col-md-8">
            ...
            <p>There are actually 2 versions of this web application currently in the works.</p>
            <ul class="main_content">
                <li><a href="#">This site which uses LAMP</a> (Linux, Apache, MySQL, PHP) as well as a Java webservice running on Tomcat.</li>
                <li>A soon to be completed <a href="#">Microsoft .NET MVC</a> (Model-View-Controller) version of the application which uses a Windows Communication Framework webservice.</li>
            </ul>
    ...
    <div class="row paragraph_row">
        ...
        <div class="col-12 col-md-8">
            ...
            <ul class="main_content">
                <li><a href="#">History</a> - gives a written history of my career in detail you wouldn't normally see on a resume</li>
                <li><a href="#">Resume</a> - is a digital version of my resume</li>
                <li><a href="#">Contact</a> - gives my contact information along with a simple form you can use to email me</li>
            </ul>
            <h5>Example Applications and Technologies</h5>
            <p>The web site itself is an example of an application I've written and parts of it are described in the <a href="examples.php">examples</a> section.</p>
